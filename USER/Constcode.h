...
extern uint16  const code table1_custom_default[ ];
extern uint16  const code table2_custom_default[ ];
...
extern uint16 const code def_tab_type50K[19];
...
extern uint16 const code tbl_hummity_freq[10][2];
