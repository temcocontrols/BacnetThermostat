...
void uart3_init(u32 bound)
{
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3, ENABLE);	//使能USART4，GPIOD时钟
//	GPIO_PinRemapConfig(GPIO_Remap_USART2,1);
...
void uart5_init(u32 bound)
{
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART5, ENABLE);	//使能USART4，GPIOD时钟
//	GPIO_PinRemapConfig(GPIO_Remap_USART2,1);
    ...
    //USART5_RX	  PD.2
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;				//PA.10
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;	//上拉输入
  ...
  NVIC_InitStructure.NVIC_IRQChannel = UART5_IRQn;
    ...
    USART_ITConfig(UART5, USART_IT_RXNE/*|USART_IT_TC*/, ENABLE);				//开启中断
//    USART_ITConfig(USART1, USART_IT_TC, ENABLE);
